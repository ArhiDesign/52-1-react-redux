...
function Counter() {
    // 11. Забираем значение каунтера из store (пункт 6. counterValue)
  ...
  const onPlus = ()=>{
    //14. Диспатчим экшен (передаём в вызов функции dispatch необходим идентификатор действия(action))
